...
Threads: 6
PID = 7962 TID = 7991
7962 7963 7964 7991 7992 7993 

Maps Information
b1a01000 b2200000 rw-p [stack:7993]
b2201000 b2a00000 rw-p [stack:7992]
b2ecb000 b36ca000 rw-p [stack:7991]
...
b3c10000 b440f000 rw-p [stack:7963]
...
b6f91000 b6f94000 rw-p [stack:7964]
...
Callstack Information (PID:7962)
Call Stack Count: 1
...
t_type_from_zip(634) > can not access to [org.tizen.nornenjs]
...
07-13 14:40:22.124+0900 W/CRASH_MANAGER( 7545): worker.c: worker_job(1236) > 11074236e6f721436766021
07-13 14:40:22.134+0900 I/Tizen::System( 1047): (259) > Active app [com.samsun], current [org.tizen.] 
07-13 14:40:22.134+0900 I/Tizen::Io( 1047): (729) > Entry not found
07-13 14:40:22.154+0900 I/Tizen::System( 1047): (157) > change brightness system value.
07-13 14:40:24.394+0900 I/MALI    (  606): egl_platform_x11_tizen.c: tizen_update_native_surface_private(172) > [EGL-X11] surface->[0xb06357f8] swap changed from async to sync
07-13 14:41:02.674+0900 E/PKGMGR_SERVER( 7778): pkgmgr-server.c: main(1608) > server start
07-13 14:41:04.534+0900 E/PKGMGR_SERVER( 7778): pkgmgr-server.c: exit_server(887) > exit_server Start [backend_status=1, queue_status=1, drm_status=1] 
07-13 14:41:04.534+0900 E/PKGMGR_SERVER( 7778): pkgmgr-server.c: main(1704) > package manager server terminated.
07-13 14:41:07.884+0900 E/PKGMGR_SERVER( 7886): pkgmgr-server.c: main(1608) > server start
07-13 14:41:07.934+0900 E/PKGMGR  ( 7886): pkgmgr-internal.c: _get_type_from_zip(634) > can not access to [org.tizen.nornenjs]
07-13 14:41:07.934+0900 E/PKGMGR_SERVER( 7886): pkgmgr-server.c: __get_type_from_msg(289) > [0;31m[__get_type_from_msg(): 289](pkgtype == NULL) pkgtype is null for org.tizen.nornenjs 
07-13 14:41:07.934+0900 E/PKGMGR_SERVER( 7886): [0;m
07-13 14:41:08.124+0900 I/Tizen::App( 1034): (1894) > PackageEventHandler - req: 1, pkg_type: rpm, pkg_name: org.tizen.nornenjs, key: start, val: update
07-13 14:41:08.124+0900 I/Tizen::App( 1034): (1584) > Package = [org.tizen.nornenjs], Key = [start], Value = [update], install = [1]
07-13 14:41:08.144+0900 W/AUL_AMD (  452): amd_appinfo.c: __amd_pkgmgrinfo_status_cb(580) > __amd_pkgmgrinfo_start_handler
07-13 14:41:08.254+0900 I/Tizen::App( 1034): (1894) > PackageEventHandler - req: 1, pkg_type: rpm, pkg_name: org.tizen.nornenjs, key: install_percent, val: 30
07-13 14:41:08.254+0900 I/Tizen::App( 1034): (119) > InstallationInProgress [30]
07-13 14:41:08.254+0900 I/Tizen::App( 1034): (1584) > Package = [org.tizen.nornenjs], Key = [install_percent], Value = [30], install = [1]
07-13 14:41:10.414+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(427) > Transaction Begin
07-13 14:41:10.424+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(496) > Id:Count = 1 93
07-13 14:41:10.424+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(496) > Id:Count = 2 93
07-13 14:41:10.424+0900 I/Tizen::App( 1034): (1894) > PackageEventHandler - req: 1, pkg_type: rpm, pkg_name: org.tizen.nornenjs, key: install_percent, val: 60
07-13 14:41:10.424+0900 I/Tizen::App( 1034): (119) > InstallationInProgress [60]
07-13 14:41:10.424+0900 I/Tizen::App( 1034): (1584) > Package = [org.tizen.nornenjs], Key = [install_percent], Value = [60], install = [1]
07-13 14:41:10.424+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(496) > Id:Count = 21 5
07-13 14:41:10.424+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(496) > Id:Count = 22 5
07-13 14:41:10.424+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(496) > Id:Count = 23 5
07-13 14:41:10.424+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(496) > Id:Count = 24 5
07-13 14:41:10.444+0900 E/PKGMGR_CERT( 7889): pkgmgrinfo_certinfo.c: pkgmgrinfo_save_certinfo(571) > Transaction Commit and End
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_make_directory(1927) > mkdir failed. appdir=[/usr/apps/org.tizen.nornenjs/shared], errno=[2][No such file or directory]
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_apply_directory_policy(1549) > skip! empty dirpath=[/usr/apps/org.tizen.nornenjs/shared]
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_apply_directory_policy(1549) > skip! empty dirpath=[/opt/usr/apps/org.tizen.nornenjs/shared/data]
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_apply_directory_policy(1549) > skip! empty dirpath=[/usr/apps/org.tizen.nornenjs/shared/res]
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_apply_file_policy(1534) > skip! empty filepath=[/usr/apps/org.tizen.nornenjs/tizen-manifest.xml]
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_apply_file_policy(1534) > skip! empty filepath=[/usr/apps/org.tizen.nornenjs/author-signature.xml]
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_apply_file_policy(1534) > skip! empty filepath=[/usr/apps/org.tizen.nornenjs/signature1.xml]
07-13 14:41:10.444+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_apply_file_policy(1534) > skip! empty filepath=[/usr/share/packages/org.tizen.nornenjs.xml]
07-13 14:41:10.534+0900 E/PKGMGR_SERVER( 7886): pkgmgr-server.c: exit_server(887) > exit_server Start [backend_status=0, queue_status=1, drm_status=1] 
07-13 14:41:10.924+0900 E/rpm-installer( 7889): coretpk-installer.c: _coretpk_installer_get_smack_label_access(1099) > Error in getting smack ACCESS label failed. result[-1] (path:[/opt/usr/apps/org.tizen.nornenjs/shared/data]))
07-13 14:41:11.784+0900 E/PKGMGR_INFO( 7889): pkgmgrinfo_feature.c: pkgmgrinfo_updateinfo_remove(528) > (strstr(vconf_str, pkgid_is) == NULL) pkgid is already removed
07-13 14:41:11.794+0900 E/PKGMGR_INSTALLER( 7889): pkgmgr_installer.c: __send_event(114) > fail to remove update-service
07-13 14:41:11.814+0900 I/Tizen::App( 1034): (1894) > PackageEventHandler - req: 1, pkg_type: rpm, pkg_name: org.tizen.nornenjs, key: install_percent, val: 100
07-13 14:41:11.814+0900 I/Tizen::App( 1034): (119) > InstallationInProgress [100]
07-13 14:41:11.814+0900 I/Tizen::App( 1034): (1584) > Package = [org.tizen.nornenjs], Key = [install_percent], Value = [100], install = [1]
07-13 14:41:11.814+0900 I/Tizen::App( 1034): (1894) > PackageEventHandler - req: 1, pkg_type: rpm, pkg_name: org.tizen.nornenjs, key: end, val: ok
07-13 14:41:11.814+0900 I/Tizen::App( 1034): (78) > Installation is Completed. [Package = org.tizen.nornenjs]
07-13 14:41:11.814+0900 I/Tizen::App( 1034): (663) > Enter. package(org.tizen.nornenjs), installationResult(0)
07-13 14:41:11.824+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: OnClientListenCb(539) >  #Step 1
07-13 14:41:11.824+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: OnClientListenCb(543) >  #Step 2
07-13 14:41:11.824+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: _GetAppIds(344) >  BEGIN
07-13 14:41:11.854+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: _PkgMgrAppInfoGetListCb(246) >  ##### [org.tizen.nornenjs]
07-13 14:41:11.854+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: _GetAppIds(369) >  ##### [org.tizen.nornenjs]
07-13 14:41:11.854+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: _GetAppIds(373) >  END
07-13 14:41:11.854+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: _DoPkgJob(452) >  #Step 3 size[1]
07-13 14:41:11.854+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: _DoPkgJob(456) >  appId[org.tizen.nornenjs]
07-13 14:41:11.864+0900 I/Tizen::App( 1034): (1360) > package(org.tizen.nornenjs), version(1.0.0), type(rpm), displayName(Nornenjs), uninstallable(1), downloaded(1), updated(1), preloaded(0)movable(1), externalStorage(0), mainApp(org.tizen.nornenjs), storeClient(), appRootPath(/opt/usr/apps/org.tizen.nornenjs)
07-13 14:41:11.874+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: _GetAppInfo(945) >  AppId[org.tizen.nornenjs] Name[Nornenjs] Icon[/opt/usr/apps/org.tizen.nornenjs/shared/res/favicon.png] enable[1] system[0]
07-13 14:41:11.874+0900 E/cluster-home(  606): mainmenu-package-manager.cpp: GetAppInfo(599) >  Find a App Info AppId[org.tizen.nornenjs] Name[Nornenjs] Icon[/opt/usr/apps/org.tizen.nornenjs/shared/res/favicon.png] enable[1] system[0]
07-13 14:41:11.884+0900 I/Tizen::App( 1034): (483) > pkgmgrinfo_appinfo_get_appid(): app = [org.tizen.nornenjs]
07-13 14:41:11.894+0900 I/Tizen::App( 1034): (416) > appName = [nornenjs]
07-13 14:41:11.904+0900 I/Tizen::App( 1034): (509) > exe = [/opt/usr/apps/org.tizen.nornenjs/bin/nornenjs], displayName = [Nornenjs], mainApp = [1], menuIconVisible = [0], serviceApp = [0]
07-13 14:41:11.904+0900 E/PKGMGR_INFO( 1034): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_get_list(717) > (component == PMINFO_SVC_APP) PMINFO_SVC_APP is done
07-13 14:41:11.904+0900 I/Tizen::App( 1034): (675) > Application count(1) in this package
07-13 14:41:11.904+0900 I/Tizen::App( 1034): (855) > Enter.
07-13 14:41:11.904+0900 I/Tizen::App( 1034): (695) > Exit.
07-13 14:41:11.904+0900 I/Tizen::App( 1034): (1584) > Package = [org.tizen.nornenjs], Key = [end], Value = [ok], install = [1]
07-13 14:41:11.914+0900 I/Tizen::App( 1034): (416) > appName = [nornenjs]
07-13 14:41:11.914+0900 I/Tizen::App( 1034): (509) > exe = [/opt/usr/apps/org.tizen.nornenjs/bin/nornenjs], displayName = [Nornenjs], mainApp = [1], menuIconVisible = [0], serviceApp = [0]
07-13 14:41:11.914+0900 I/Tizen::App( 1034): (2343) > info file is not existed. [/opt/usr/apps/org.tizen./info/org.tizen.nornenjs.info]
07-13 14:41:11.914+0900 I/Tizen::App( 1034): (131) > Enter
07-13 14:41:11.914+0900 I/Tizen::App( 1034): (137) > org.tizen.nornenjs does not have launch condition
07-13 14:41:11.914+0900 I/Tizen::App( 1034): (898) > Exit.
07-13 14:41:12.534+0900 E/PKGMGR_SERVER( 7886): pkgmgr-server.c: exit_server(887) > exit_server Start [backend_status=1, queue_status=1, drm_status=1] 
07-13 14:41:12.534+0900 E/PKGMGR_SERVER( 7886): pkgmgr-server.c: main(1704) > package manager server terminated.
07-13 14:41:13.234+0900 W/AUL_AMD (  452): amd_request.c: __request_handler(601) > __request_handler: 0
07-13 14:41:13.244+0900 I/AUL     (  452): menu_db_util.h: _get_app_info_from_db_by_apppath(240) > path : /usr/bin/launch_app, ret : 0
07-13 14:41:13.254+0900 I/AUL     (  452): menu_db_util.h: _get_app_info_from_db_by_apppath(240) > path : /bin/bash, ret : 0
07-13 14:41:13.254+0900 E/AUL_AMD (  452): amd_appinfo.c: appinfo_get_value(791) > appinfo get value: Invalid argument, 24
07-13 14:41:13.334+0900 I/CAPI_APPFW_APPLICATION( 7962): app_main.c: ui_app_main(699) > app_efl_main
07-13 14:41:13.374+0900 I/UXT     ( 7962): uxt_object_manager.cpp: on_initialized(287) > Initialized.
07-13 14:41:13.384+0900 E/RESOURCED(  768): proc-main.c: resourced_proc_status_change(614) > [resourced_proc_status_change,614] available memory = 431
07-13 14:41:13.394+0900 I/Tizen::App( 1034): (499) > LaunchedApp(org.tizen.nornenjs)
07-13 14:41:13.394+0900 I/Tizen::App( 1034): (733) > Finished invoking application event listener for org.tizen.nornenjs, 7962.
07-13 14:41:13.414+0900 I/Tizen::App( 1047): (733) > Finished invoking application event listener for org.tizen.nornenjs, 7962.
07-13 14:41:13.454+0900 I/CAPI_APPFW_APPLICATION( 7962): app_main.c: _ui_app_appcore_create(560) > app_appcore_create
07-13 14:41:13.724+0900 I/CAPI_APPFW_APPLICATION( 7962): app_main.c: _ui_app_appcore_reset(642) > app_appcore_reset
07-13 14:41:13.734+0900 I/APP_CORE( 7962): appcore-efl.c: __do_app(509) > Legacy lifecycle: 0
07-13 14:41:13.734+0900 I/APP_CORE( 7962): appcore-efl.c: __do_app(511) > [APP 7962] Initial Launching, call the resume_cb
07-13 14:41:13.734+0900 I/CAPI_APPFW_APPLICATION( 7962): app_main.c: _ui_app_appcore_resume(624) > app_appcore_resume
07-13 14:41:13.774+0900 W/PROCESSMGR(  377): e_mod_processmgr.c: _e_mod_processmgr_send_mDNIe_action(577) > [PROCESSMGR] =====================> Broadcast mDNIeStatus : PID=7962
07-13 14:41:13.814+0900 W/AUL_AMD (  452): amd_request.c: __request_handler(601) > __request_handler: 15
07-13 14:41:13.814+0900 W/APP_CORE( 7962): appcore-efl.c: __show_cb(822) > [EVENT_TEST][EVENT] GET SHOW EVENT!!!. WIN:4c00003
07-13 14:41:13.834+0900 I/indicator(  492): indicator_ui.c: _property_changed_cb(1238) > "app pkgname = org.tizen.nornenjs, pid = 7962"
07-13 14:41:13.844+0900 I/MALI    (  606): egl_platform_x11_tizen.c: tizen_update_native_surface_private(181) > [EGL-X11] surface->[0xb06357f8] swap changed from sync to async
07-13 14:41:13.864+0900 I/Tizen::System( 1047): (259) > Active app [org.tizen.], current [com.samsun] 
07-13 14:41:13.884+0900 I/Tizen::Io( 1047): (729) > Entry not found
07-13 14:41:13.894+0900 I/Tizen::System( 1047): (157) > change brightness system value.
07-13 14:41:13.924+0900 I/CAPI_APPFW_APPLICATION(  606): app_main.c: app_appcore_pause(202) > app_appcore_pause
07-13 14:41:13.924+0900 E/cluster-home(  606): homescreen-main.cpp: app_pause(355) >  app pause
07-13 14:41:13.984+0900 W/AUL_AMD (  452): amd_key.c: _key_ungrab(250) > fail(-1) to ungrab key(XF86Stop)
07-13 14:41:13.984+0900 W/AUL_AMD (  452): amd_launch.c: __e17_status_handler(2132) > back key ungrab error
07-13 14:41:16.284+0900 I/MALI    ( 7962): egl_platform_x11_tizen.c: tizen_update_native_surface_private(172) > [EGL-X11] surface->[0xb7d187a8] swap changed from async to sync
07-13 14:41:16.724+0900 I/nornenjs( 7962): Timer expired after 3.001 seconds.
07-13 14:41:16.724+0900 E/EFL     ( 7962): ecore<7962> ecore.c:568 _ecore_magic_fail() 
07-13 14:41:16.724+0900 E/EFL     ( 7962): *** ECORE ERROR: Ecore Magic Check Failed!!!
07-13 14:41:16.724+0900 E/EFL     ( 7962): *** IN FUNCTION: ecore_timer_delay()
07-13 14:41:16.724+0900 E/EFL     ( 7962): ecore<7962> ecore.c:570 _ecore_magic_fail()   Input handle pointer is NULL!
07-13 14:41:16.724+0900 E/EFL     ( 7962): ecore<7962> ecore.c:581 _ecore_magic_fail() *** NAUGHTY PROGRAMMER!!!
07-13 14:41:16.724+0900 E/EFL     ( 7962): *** SPANK SPANK SPANK!!!
07-13 14:41:16.724+0900 E/EFL     ( 7962): *** Now go fix your code. Tut tut tut!
07-13 14:41:16.754+0900 E/EFL     ( 7962): evas_main<7962> evas_font_dir.c:70 _evas_font_init_instance() ENTER:: evas_font_init
07-13 14:41:16.774+0900 E/EFL     ( 7962): evas_main<7962> evas_font_dir.c:90 evas_font_init() DONE:: evas_font_init
07-13 14:41:19.184+0900 E/socket.io( 7962): 566: Connected.
07-13 14:41:19.184+0900 E/socket.io( 7962): 554: On handshake, sid
07-13 14:41:19.184+0900 E/socket.io( 7962): 651: Received Message type(connect)
07-13 14:41:19.184+0900 E/socket.io( 7962): 489: On Connected
07-13 14:41:19.184+0900 F/sio_packet( 7962): accept()
07-13 14:41:19.184+0900 E/socket.io( 7962): 743: encoded paylod length: 41
07-13 14:41:19.194+0900 E/socket.io( 7962): 800: ping exit, con is expired? 0, ec: Operation canceled
07-13 14:41:19.304+0900 E/socket.io( 7962): 669: Received Message type(Event)
07-13 14:41:19.304+0900 F/sio_packet( 7962): accept()
07-13 14:41:19.304+0900 E/socket.io( 7962): 743: encoded paylod length: 21
07-13 14:41:19.304+0900 E/socket.io( 7962): 800: ping exit, con is expired? 0, ec: Operation canceled
07-13 14:41:19.394+0900 W/CRASH_MANAGER( 7995): worker.c: worker_job(1236) > 11079626e6f72143676607
